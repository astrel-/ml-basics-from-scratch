...
[[maybe_unused]] static std::vector<double> matmul_AB_raw(const double *A, const double *B, int k,
                                                          int m, int n, double alpha = 1.0) {
...
static std::vector<double> matmul_AB_T_raw(const double *A, const double *B, int k, int m, int n,
                                           double alpha = 1.0) {
