...
//    };
//
//    static std::function<double(double...)> func(double a...) {
//        return [a](double x...) { return f(x - a); }
//    }
//
...
//
// //template<typename... >
// //class TestSquaredFunctions2 {
// //    // funcs
// //    static double f(Types... x)
//
// //};
//
// template <typename... Args> 
// static double f(Args... x) {
//     double result = 0.0;
//     ((result += x * x), ...);
//     return result;
// }
...
int main() {
    containers::array<2> arr1{1.0, 2.0};
    containers::array<2> arr2{1.0, 1.0};

    const auto res = arr1 - arr2;
    ...
    ////auto f1 = TestSquaredFunctions::func(a1);
    //auto f1 = f(2.0);
